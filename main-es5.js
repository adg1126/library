...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        /*! import() | my-books-my-books-module */
        "my-books-my-books-module").then(__webpack_require__.bind(null,
        /*! ./my-books/my-books.module */
        "./src/app/my-books/my-books.module.ts")).then(function (m) {
          return m.MyBooksModule;
        });
      }
    }];
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _search_search_bar_search_bar_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./search/search-bar/search-bar.component */
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 9,
      vars: 2,
      consts: [[1, "ui", "inverted", "menu"], ["routerLink", "/", "routerLinkActive", "active", 1, "item", 3, "routerLinkActiveOptions"], ["routerLink", "/my-books", "routerLinkActive", "active", 1, "item"], [1, "right", "menu"], [1, "ui", "segment"]],
      ...
      directives: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterLinkWithHref"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterLinkActive"], _search_search_bar_search_bar_component__WEBPACK_IMPORTED_MODULE_2__["SearchBarComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterOutlet"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./node_modules/@angular/fire/__ivy_ngcc__/fesm2015/angular-fire-storage.js"); // import { AngularFireAuthModule } from '@angular/fire/auth';
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _search_search_module__WEBPACK_IMPORTED_MODULE_5__["SearchModule"], _angular_fire__WEBPACK_IMPORTED_MODULE_6__["AngularFireModule"].initializeApp(config), _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_7__["AngularFirestoreModule"], // AngularFireAuthModule, // auth
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        ...
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _search_search_module__WEBPACK_IMPORTED_MODULE_5__["SearchModule"], _angular_fire__WEBPACK_IMPORTED_MODULE_6__["AngularFireModule"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_7__["AngularFirestoreModule"], // AngularFireAuthModule, // auth
        _angular_fire_storage__WEBPACK_IMPORTED_MODULE_8__["AngularFireStorageModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppSearchSearchBarSearchBarComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _services_google_books_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    var SearchBarComponent = /*#__PURE__*/function () {
      function SearchBarComponent(googleBooksService, router, firebaseService) {
        ...
        value: function onFormSubmit(event) {
          ...
          this.googleBooksService.search(this.term).subscribe({
            next: function next(books) {
              _this.router.navigateByUrl('/search-result');

              _this.firebaseService.sendToBookList(books);
            }
          });
        }
      }]);
    ...
    SearchBarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 4,
      vars: 0,
      consts: [[1, "item"], [1, "ui", "inverted", "transparent", "icon", "input", 3, "submit"], ["type", "text", "placeholder", "Search for a title or an author", 3, "input"], [1, "search", "icon"]],
      template: function SearchBarComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("submit", function SearchBarComponent_Template_form_submit_1_listener($event) {
            return ctx.onFormSubmit($event);
          });

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "input", 2);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("input", function SearchBarComponent_Template_input_input_2_listener($event) {
            return ctx.term = $event.target.value;
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SearchBarComponent, [{
        ...
        return [{
          type: _services_google_books_service__WEBPACK_IMPORTED_MODULE_1__["GoogleBooksService"]
        }, {
  ...
  function srcAppSearchSearchResultsSearchResultsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function SearchResultsComponent_div_0_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SearchResultsComponent_div_0_div_1_Template_button_click_7_listener() {
          ...
          return ctx_r3.addBook(book_r2.volumeInfo);
        });
    ...
    function SearchResultsComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var SearchResultsComponent = /*#__PURE__*/function () {
      function SearchResultsComponent(firebaseService) {
      ...
      _createClass(SearchResultsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.firebaseService.currentBooks$.subscribe(function (books) {
            _this2.books = books;
          });
        }
      }, {
        key: "addBook",
        value: function addBook(bookInfo) {
          var book = {
    ...
    SearchResultsComponent.ɵfac = function SearchResultsComponent_Factory(t) {
      return new (t || SearchResultsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_firebase_service__WEBPACK_IMPORTED_MODULE_1__["FirebaseService"]));
    };
    ...
    SearchResultsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 1,
      vars: 1,
      consts: [["class", "container", 4, "ngIf"], [1, "container"], ["class", "book", 4, "ngFor", "ngForOf"], [1, "book"], ["alt", "", 3, "src"], [1, "title"], [1, "author"], [1, "buttons"], [1, "ui", "primary", "button", 3, "click"]],
  ...
  function srcAppSearchSearchRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _search_results_search_results_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
  ...
  function srcAppServicesFirebaseServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var FirebaseService = /*#__PURE__*/function () {
      function FirebaseService(afs) {
        ...
        this.firebaseBooks = this.booksCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (changes) {
      ...
      _createClass(FirebaseService, [{
        key: "sendToBookList",
        value: function sendToBookList(books) {
        ...
        value: function deleteBook(book) {
          this.bookDoc = this.afs.doc("books/".concat(book.id));
          this.bookDoc["delete"]();
        }
      }, {
        key: "markAsRead",
        value: function markAsRead(book) {
          this.bookDoc = this.afs.doc("books/".concat(book.id));
          this.bookDoc.update({
            status: 'Read'
          });
        ...
        key: "markAsUnread",
        value: function markAsUnread(book) {
          this.bookDoc = this.afs.doc("books/".concat(book.id));
          this.bookDoc.update({
            status: 'Unread'
          });
  ...
  function srcAppServicesGoogleBooksServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var GoogleBooksService = /*#__PURE__*/function () {
      ...
      _createClass(GoogleBooksService, [{
        ...
        value: function search(term) {
          return this.http.get("https://www.googleapis.com/books/v1/volumes?q=".concat(term)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (book) {
            return book.items;
          }));
        }
      }]);
    ...
    GoogleBooksService.ɵfac = function GoogleBooksService_Factory(t) {
      return new (t || GoogleBooksService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]));
    };

    GoogleBooksService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](GoogleBooksService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
          providedIn: 'root'
        }]
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/dyan/Desktop/the-odin-project/2-javascript/1-organizing-js/library/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
